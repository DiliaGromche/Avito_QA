...
user_name.send_keys('test_old@mail.ru')
password = driver.find_element(By.NAME,"password")
password.send_keys('test_old')
...
driver.get_screenshot_as_file('/Users/dilia/PycharmProjects/selenium_test1/pythonProject/output/3.png')
driver.quit()
